...
extern struct gen_pool *gen_pool_meta_create(int min_alloc_order, int nid);
extern void gen_pool_meta_destroy(struct gen_pool_meta *meta);
extern size_t get_meta(struct gen_pool_meta *meta, int name);
extern void set_meta(struct gen_pool_meta *meta, int name, size_t size);
